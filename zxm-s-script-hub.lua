...
local Colors = {
    ...
    CloseRed = Color3.fromRGB(220, 60, 60),
...
local function createMainUI()
    ...
    local closeBtn = createControlButton("Close", Colors.CloseRed, Colors.CloseRed:Lerp(Color3.fromRGB(255,255,255), 0.2), "×")
    ...
    -- ===== MAIN TAB: SCRIPT LIST =====
    local mainScroll = Instance.new("ScrollingFrame")
    mainScroll.Name = "ScriptList"
    mainScroll.Size = UDim2.new(1, 0, 1, 0)
    mainScroll.BackgroundTransparency = 1
    mainScroll.BorderSizePixel = 0
    mainScroll.ScrollBarThickness = 4
    mainScroll.ScrollBarImageColor3 = Colors.Border
    mainScroll.ScrollingDirection = Enum.ScrollingDirection.Y
    mainScroll.AutomaticCanvasSize = Enum.AutomaticSize.Y
    mainScroll.CanvasSize = UDim2.new(0, 0, 0, 0)
    mainScroll.Parent = tabContents["Main"]
    ...
    scrollPadding.Parent = mainScroll
    ...
    local function createScriptItem(data, index)
        ...
        itemContainer.Parent = mainScroll
        ...
        -- Preview Panel (hidden by default, appears below header)
        ...
        -- Bottom bar for Execute button and Status
        ...
        executeBtn.MouseButton1Click:Connect(function()
            ...
            if success then
                ...
                statusLabel.Text = "Failed: " .. tostring(err):sub(1, 50)
